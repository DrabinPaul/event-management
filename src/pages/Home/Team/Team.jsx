                ...
                >
                    <SwiperSlide>
                        <div className='relative'>
                            ...
                            <div className="absolute z-[1000] top-40 m-10 bg-[#fe3e01] justify-center items-center rounded flex w-[330px] px-4 py-2">
                                <h3 className="text-xl text-left pr-4 text-white font-bold uppercase mb-2" >Lara <br />Gomez</h3>
                    ...
                    <SwiperSlide>
                        <div className='relative'>
                            ...
                            <div className="absolute z-[1000] top-40 m-10 bg-[#fe3e01] justify-center items-center text-center rounded flex w-[330px]  px-4 py-2">
